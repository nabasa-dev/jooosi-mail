...
final readonly class AutoloadDiscoveryLocations
{
    ...
    public function __construct(private string $rootPath, ?Composer $composer = null)
    {
    ...
    public function __invoke(): array
    {
        ...
        return [...$this->discoverInstalledPackages($composerPath, $packages), ...$this->discoverAppNamespaces()];
    }
