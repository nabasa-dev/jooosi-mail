...
trait IsEnumHelper
{
    ...
    {
        $cases = array_filter(static::cases(), fn(UnitEnum $case) => $case->name === $name);
    ...
    public static function has(string $name): bool
    {
        ...
        return in_array($name, $caseNames, strict: \true);
    ...
    public static function hasValue(string|int $value): bool
    {
        ...
        $class = static::class;
        $caseValues = is_subclass_of($class, BackedEnum::class) ? array_column(static::cases(), 'value') : array_column(static::cases(), 'name');
        return in_array($value, $caseValues, strict: \true);
        // @phpstan-ignore-line function.impossibleType ( prevent to always evaluate to true/false as in enum context the result is predictable )
    }
    /**
    ...
    public static function values(): array
    {
        /** @var class-string<TEnum> */
        $class = static::class;
        return is_subclass_of($class, BackedEnum::class) ? array_column(static::cases(), 'value') : array_column(static::cases(), 'name');
    }
    /**
    ...
    public static function options(): array
    {
        /** @var class-string<TEnum> */
        $class = static::class;
        return is_subclass_of($class, BackedEnum::class) ? array_column(static::cases(), 'value', 'name') : self::values();
    }
}
