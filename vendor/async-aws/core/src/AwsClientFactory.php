...
use JooosiMailDeps\AsyncAws\CloudWatch\CloudWatchClient;
use JooosiMailDeps\AsyncAws\CloudWatchLogs\CloudWatchLogsClient;
use JooosiMailDeps\AsyncAws\CodeBuild\CodeBuildClient;
use JooosiMailDeps\AsyncAws\CodeCommit\CodeCommitClient;
use JooosiMailDeps\AsyncAws\CodeDeploy\CodeDeployClient;
use JooosiMailDeps\AsyncAws\CognitoIdentityProvider\CognitoIdentityProviderClient;
use JooosiMailDeps\AsyncAws\Comprehend\ComprehendClient;
...
use JooosiMailDeps\AsyncAws\Kms\KmsClient;
use JooosiMailDeps\AsyncAws\Lambda\LambdaClient;
use JooosiMailDeps\AsyncAws\LocationService\LocationServiceClient;
use JooosiMailDeps\AsyncAws\MediaConvert\MediaConvertClient;
use JooosiMailDeps\AsyncAws\RdsDataService\RdsDataServiceClient;
...
use JooosiMailDeps\AsyncAws\Sns\SnsClient;
use JooosiMailDeps\AsyncAws\Sqs\SqsClient;
use JooosiMailDeps\AsyncAws\Ssm\SsmClient;
use JooosiMailDeps\AsyncAws\Sso\SsoClient;
use JooosiMailDeps\AsyncAws\SsoOidc\SsoOidcClient;
use JooosiMailDeps\AsyncAws\StepFunctions\StepFunctionsClient;
use JooosiMailDeps\AsyncAws\TimestreamQuery\TimestreamQueryClient;
use JooosiMailDeps\AsyncAws\TimestreamWrite\TimestreamWriteClient;
use JooosiMailDeps\AsyncAws\Translate\TranslateClient;
use JooosiMailDeps\AsyncAws\XRay\XRayClient;
