...
use OmniMailDeps\AsyncAws\AppSync\AppSyncClient;
use OmniMailDeps\AsyncAws\Athena\AthenaClient;
use OmniMailDeps\AsyncAws\BedrockAgent\BedrockAgentClient;
use OmniMailDeps\AsyncAws\BedrockRuntime\BedrockRuntimeClient;
use OmniMailDeps\AsyncAws\CloudFormation\CloudFormationClient;
use OmniMailDeps\AsyncAws\CloudFront\CloudFrontClient;
use OmniMailDeps\AsyncAws\CloudWatch\CloudWatchClient;
use OmniMailDeps\AsyncAws\CloudWatchLogs\CloudWatchLogsClient;
use OmniMailDeps\AsyncAws\CodeBuild\CodeBuildClient;
use OmniMailDeps\AsyncAws\CodeCommit\CodeCommitClient;
use OmniMailDeps\AsyncAws\CodeDeploy\CodeDeployClient;
use OmniMailDeps\AsyncAws\CognitoIdentityProvider\CognitoIdentityProviderClient;
use OmniMailDeps\AsyncAws\Comprehend\ComprehendClient;
...
use OmniMailDeps\AsyncAws\Core\Exception\MissingDependency;
use OmniMailDeps\AsyncAws\Core\Sts\StsClient;
use OmniMailDeps\AsyncAws\DynamoDb\DynamoDbClient;
use OmniMailDeps\AsyncAws\Ec2\Ec2Client;
use OmniMailDeps\AsyncAws\Ecr\EcrClient;
use OmniMailDeps\AsyncAws\ElastiCache\ElastiCacheClient;
use OmniMailDeps\AsyncAws\EventBridge\EventBridgeClient;
use OmniMailDeps\AsyncAws\Firehose\FirehoseClient;
use OmniMailDeps\AsyncAws\Iam\IamClient;
use OmniMailDeps\AsyncAws\ImageBuilder\ImageBuilderClient;
use OmniMailDeps\AsyncAws\Iot\IotClient;
use OmniMailDeps\AsyncAws\IotData\IotDataClient;
use OmniMailDeps\AsyncAws\Kinesis\KinesisClient;
use OmniMailDeps\AsyncAws\Kms\KmsClient;
use OmniMailDeps\AsyncAws\Lambda\LambdaClient;
use OmniMailDeps\AsyncAws\LocationService\LocationServiceClient;
use OmniMailDeps\AsyncAws\MediaConvert\MediaConvertClient;
use OmniMailDeps\AsyncAws\RdsDataService\RdsDataServiceClient;
use OmniMailDeps\AsyncAws\Rekognition\RekognitionClient;
use OmniMailDeps\AsyncAws\Route53\Route53Client;
use OmniMailDeps\AsyncAws\S3\S3Client;
use OmniMailDeps\AsyncAws\S3Vectors\S3VectorsClient;
use OmniMailDeps\AsyncAws\Scheduler\SchedulerClient;
use OmniMailDeps\AsyncAws\SecretsManager\SecretsManagerClient;
use OmniMailDeps\AsyncAws\Ses\SesClient;
use OmniMailDeps\AsyncAws\Sns\SnsClient;
use OmniMailDeps\AsyncAws\Sqs\SqsClient;
use OmniMailDeps\AsyncAws\Ssm\SsmClient;
use OmniMailDeps\AsyncAws\Sso\SsoClient;
use OmniMailDeps\AsyncAws\SsoOidc\SsoOidcClient;
use OmniMailDeps\AsyncAws\StepFunctions\StepFunctionsClient;
use OmniMailDeps\AsyncAws\TimestreamQuery\TimestreamQueryClient;
use OmniMailDeps\AsyncAws\TimestreamWrite\TimestreamWriteClient;
use OmniMailDeps\AsyncAws\Translate\TranslateClient;
use OmniMailDeps\AsyncAws\XRay\XRayClient;
