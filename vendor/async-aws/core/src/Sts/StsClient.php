...
class StsClient extends AbstractApi
{
    ...
    protected function getEndpointMetadata(?string $region): array
    {
        ...
        switch ($region) {
            ...
            case 'eusc-de-east-1':
                return ['endpoint' => 'https://sts.eusc-de-east-1.amazonaws.eu', 'signRegion' => 'eusc-de-east-1', 'signService' => 'sts', 'signVersions' => ['v4']];
            case 'us-east-1-fips':
            ...
            case 'us-isob-east-1':
            case 'us-isob-west-1':
                return ['endpoint' => "https://sts.{$region}.sc2s.sgov.gov", 'signRegion' => $region, 'signService' => 'sts', 'signVersions' => ['v4']];
            case 'us-isof-east-1':
