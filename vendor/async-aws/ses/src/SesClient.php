...
class SesClient extends AbstractApi
{
    ...
    public function deleteSuppressedDestination($input): DeleteSuppressedDestinationResponse
    {
        ...
        $response = $this->getResponse($input->request(), new RequestContext(['operation' => 'DeleteSuppressedDestination', 'region' => $input->getRegion(), 'exceptionMapping' => ['BadRequestException' => BadRequestException::class, 'NotFoundException' => NotFoundException::class, 'TooManyRequestsException' => TooManyRequestsException::class]]));
    ...
    public function getSuppressedDestination($input): GetSuppressedDestinationResponse
    {
        ...
        $response = $this->getResponse($input->request(), new RequestContext(['operation' => 'GetSuppressedDestination', 'region' => $input->getRegion(), 'exceptionMapping' => ['BadRequestException' => BadRequestException::class, 'NotFoundException' => NotFoundException::class, 'TooManyRequestsException' => TooManyRequestsException::class]]));
    ...
    public function sendEmail($input): SendEmailResponse
    {
        ...
        $response = $this->getResponse($input->request(), new RequestContext(['operation' => 'SendEmail', 'region' => $input->getRegion(), 'exceptionMapping' => ['AccountSuspendedException' => AccountSuspendedException::class, 'BadRequestException' => BadRequestException::class, 'LimitExceededException' => LimitExceededException::class, 'MailFromDomainNotVerifiedException' => MailFromDomainNotVerifiedException::class, 'MessageRejected' => MessageRejectedException::class, 'NotFoundException' => NotFoundException::class, 'SendingPausedException' => SendingPausedException::class, 'TooManyRequestsException' => TooManyRequestsException::class]]));
    ...
    protected function getEndpointMetadata(?string $region): array
    {
        ...
        switch ($region) {
            case 'eusc-de-east-1':
                return ['endpoint' => 'https://email.eusc-de-east-1.amazonaws.eu', 'signRegion' => 'eusc-de-east-1', 'signService' => 'ses', 'signVersions' => ['v4']];
            case 'fips-ca-central-1':
                return ['endpoint' => 'https://email-fips.ca-central-1.amazonaws.com', 'signRegion' => 'ca-central-1', 'signService' => 'ses', 'signVersions' => ['v4']];
            case 'fips-us-east-1':
                return ['endpoint' => 'https://email-fips.us-east-1.amazonaws.com', 'signRegion' => 'us-east-1', 'signService' => 'ses', 'signVersions' => ['v4']];
            case 'fips-us-east-2':
                return ['endpoint' => 'https://email-fips.us-east-2.amazonaws.com', 'signRegion' => 'us-east-2', 'signService' => 'ses', 'signVersions' => ['v4']];
            case 'fips-us-west-1':
                return ['endpoint' => 'https://email-fips.us-west-1.amazonaws.com', 'signRegion' => 'us-west-1', 'signService' => 'ses', 'signVersions' => ['v4']];
            case 'fips-us-west-2':
                return ['endpoint' => 'https://email-fips.us-west-2.amazonaws.com', 'signRegion' => 'us-west-2', 'signService' => 'ses', 'signVersions' => ['v4']];
            case 'fips-us-gov-east-1':
                return ['endpoint' => 'https://email-fips.us-gov-east-1.amazonaws.com', 'signRegion' => 'us-gov-east-1', 'signService' => 'ses', 'signVersions' => ['v4']];
            case 'fips-us-gov-west-1':
                return ['endpoint' => 'https://email-fips.us-gov-west-1.amazonaws.com', 'signRegion' => 'us-gov-west-1', 'signService' => 'ses', 'signVersions' => ['v4']];
        }
        return ['endpoint' => "https://email.{$region}.amazonaws.com", 'signRegion' => $region, 'signService' => 'ses', 'signVersions' => ['v4']];
    }
