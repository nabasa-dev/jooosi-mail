...
final class PhpDocAwareReflectionTypeResolver implements TypeResolverInterface
{
    ...
    public function __construct(private readonly TypeResolverInterface $reflectionTypeResolver, private readonly TypeResolverInterface $stringTypeResolver, private readonly TypeContextFactory $typeContextFactory, ?PhpDocParser $phpDocParser = null, ?Lexer $lexer = null)
    {
