    ...
    public function create(Dsn $dsn): TransportInterface
    {
        ...
        switch ($dsn->getScheme()) {
            ...
            case 'brevo+smtp':
                ...
                break;
            case 'brevo+api':
                return (new BrevoApiTransport($this->getUser($dsn), $this->client, $this->dispatcher, $this->logger))->setHost('default' === $dsn->getHost() ? null : $dsn->getHost())->setPort($dsn->getPort());
        }
