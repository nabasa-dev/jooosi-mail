...
use JooosiMailDeps\Symfony\Component\HttpClient\Internal\FollowRedirectsTrait;
...
final class DnsResolvingHttpClient implements HttpClientInterface, ResetInterface
{
     ...
     */
    public function __construct(private HttpClientInterface $client, callable $resolver)
    {
