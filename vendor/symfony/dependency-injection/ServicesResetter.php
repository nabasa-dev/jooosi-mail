...
use JooosiMailDeps\ProxyManager\Proxy\LazyLoadingInterface;
...
class ServicesResetter implements ServicesResetterInterface
{
     ...
     */
    public function __construct(private \Traversable $resettableServices, private array $resetMethods, private ?\WeakMap $resetMap = null)
    {
    }
