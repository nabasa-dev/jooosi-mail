...
class ResettableServicePass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        $resetter->setArgument(0, new IteratorArgument($services))->setArgument(1, $methods);
        if ($hasNonShared) {
            $resetter->setArgument(2, (new Definition(\WeakMap::class))->setFactory([new Reference('service_container'), 'getResetMap']));
        }
    }
}
