...
{
    private const DEFAULT_TAGS = ['container.do_not_inline', 'container.service_locator', 'container.service_subscriber'];
    /**
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        $container->setParameter('container.behavior_describing_tags', array_unique(array_merge($tags, $this->tags)));
    }
}
