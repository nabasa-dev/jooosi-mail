...
use JooosiMailDeps\Composer\InstalledVersions;
use JooosiMailDeps\Symfony\Component\Config\Resource\ClassExistenceResource;
use JooosiMailDeps\Symfony\Component\Config\Resource\ComposerResource;
use JooosiMailDeps\Symfony\Component\Config\Resource\DirectoryResource;
use JooosiMailDeps\Symfony\Component\Config\Resource\FileExistenceResource;
...
use JooosiMailDeps\Symfony\Component\Config\Resource\ReflectionClassResource;
...
use JooosiMailDeps\Symfony\Component\DependencyInjection\Compiler\Compiler;
...
use JooosiMailDeps\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
...
use JooosiMailDeps\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use JooosiMailDeps\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\LazyServiceInstantiator;
use JooosiMailDeps\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
...
class ContainerBuilder extends Container implements TaggedContainerInterface
{
    ...
    private function doResolveServices(mixed $value, array &$inlineServices = [], bool $isConstructorArgument = \false): mixed
    {
        if (\is_array($value)) {
            ...
            $expr = $value->getValue();
            $envClosure = new EnvClosure(fn() => $this->resolveEnvPlaceholders($expr, \true), $value->getDefault());
     ...
     * @return array<string, array> An array of tags with the tagged service as key, holding a list of attribute arrays
     */
    public function findTaggedResourceIds(string $tagName, bool $throwOnAbstract = \true): array
    {
