 ...
 */
namespace JooosiMailDeps\Symfony\Component\DependencyInjection\Argument;
...
class TaggedIteratorArgument extends IteratorArgument
{
     ...
     */
    public function __construct(private string $tag, ?string $indexAttribute = null, bool|string|null $needsIndexes = \false, array|bool $exclude = [], bool|string|null $excludeSelf = \true)
    {
        parent::__construct([]);
        if (\func_num_args() > 5 || !\is_bool($needsIndexes) || !\is_array($exclude) || !\is_bool($excludeSelf)) {
            [, , $defaultIndexMethod, $needsIndexes, $defaultPriorityMethod, $exclude, $excludeSelf] = \func_get_args() + [2 => null, \false, null, [], \true];
