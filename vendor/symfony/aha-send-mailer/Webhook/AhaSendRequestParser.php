 ...
 */
namespace JooosiMailDeps\Symfony\Component\Mailer\Bridge\AhaSend\Webhook;
...
use JooosiMailDeps\Symfony\Component\Mailer\Bridge\AhaSend\RemoteEvent\AhaSendPayloadConverter;
...
{
    public function __construct(private readonly AhaSendPayloadConverter $converter)
    {
    }
