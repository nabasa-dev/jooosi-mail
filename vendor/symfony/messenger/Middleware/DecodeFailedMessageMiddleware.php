...
{
    public function __construct(private ContainerInterface $serializerLocator)
    {
    }
    public function handle(Envelope $envelope, StackInterface $stack): Envelope
    {
        ...
        $transportName = $envelope->last(SentToFailureTransportStamp::class)?->getOriginalReceiverName() ?? $envelope->last(ReceivedStamp::class)?->getTransportName() ?? throw new LogicException('A ReceivedStamp is required to decode a serialized envelope message.');
