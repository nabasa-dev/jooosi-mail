...
use JooosiMailDeps\Symfony\Component\Messenger\Exception\DelayedMessageHandlingException;
use JooosiMailDeps\Symfony\Component\Messenger\Stamp\DispatchAfterCurrentBusStamp;
/**
...
class DispatchAfterCurrentBusMiddleware implements MiddlewareInterface
{
    ...
    public function handle(Envelope $envelope, StackInterface $stack): Envelope
    {
        ...
        $this->isRootDispatchCallRunning = \true;
        try {
...
final class QueuedEnvelope
{
    ...
    public function __construct(Envelope $envelope, private StackInterface $stack)
    {
