...
class ConsumeMessagesCommand extends Command implements SignalableCommandInterface
{
    ...
    public function __construct(private RoutableMessageBus $routableBus, private ContainerInterface $receiverLocator, private EventDispatcherInterface $eventDispatcher, private ?LoggerInterface $logger = null, private array $receiverNames = [], private ?ResetServicesListener $resetServicesListener = null, private array $busIds = [], private ?ContainerInterface $rateLimiterLocator = null, private ?array $signals = null)
    {
        parent::__construct();
    }
...
EOF
    ...
    protected function interact(InputInterface $input, OutputInterface $output): void
    {
        ...
        if ($this->receiverNames && !$input->getArgument('receivers')) {
            ...
            $io->block('Which transports/receivers do you want to consume?', null, 'fg=white;bg=blue', ' ', \true);
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $options = ['sleep' => $input->getOption('sleep') * 1000000, 'time_limit' => null !== $timeLimit ? (int) $timeLimit : null];
