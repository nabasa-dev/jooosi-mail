...
class MultiplierRetryStrategy implements RetryStrategyInterface
{
     ...
     */
    public function __construct(private int $maxRetries = 3, private int $delayMilliseconds = 1000, private float $multiplier = 1, private int $maxDelayMilliseconds = 0, private float $jitter = 0.1)
    {
