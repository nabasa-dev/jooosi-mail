...
use JooosiMailDeps\Symfony\Component\Lock\Key;
...
{
    private Key $key;
    public function __construct(string|Key $key, private ?float $ttl = 300.0, private bool $onlyDeduplicateInQueue = \false)
    {
