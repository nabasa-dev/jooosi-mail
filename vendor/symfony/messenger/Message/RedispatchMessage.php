 ...
 */
namespace JooosiMailDeps\Symfony\Component\Messenger\Message;
...
final class RedispatchMessage implements \Stringable
{
     ...
     */
    public function __construct(public readonly object $envelope, public readonly array|string $transportNames = [])
    {
    }
