...
use Closure;
use OmniMailDeps\Doctrine\DBAL\Cache\ArrayResult;
use OmniMailDeps\Doctrine\DBAL\Cache\CacheException;
use OmniMailDeps\Doctrine\DBAL\Cache\Exception\NoResultDriverConfigured;
use OmniMailDeps\Doctrine\DBAL\Cache\QueryCacheProfile;
use OmniMailDeps\Doctrine\DBAL\Connection\StaticServerVersionProvider;
...
use OmniMailDeps\Doctrine\DBAL\Driver\Exception as TheDriverException;
use OmniMailDeps\Doctrine\DBAL\Driver\Statement as DriverStatement;
use OmniMailDeps\Doctrine\DBAL\Exception\CommitFailedRollbackOnly;
...
use OmniMailDeps\Doctrine\DBAL\Exception\NoActiveTransaction;
use OmniMailDeps\Doctrine\DBAL\Exception\ParseError;
use OmniMailDeps\Doctrine\DBAL\Exception\SavepointsNotSupported;
...
class Connection implements ServerVersionProvider
{
    ...
    public function delete(string $table, array $criteria = [], array $types = []): int|string
    {
        ...
        return $this->executeStatement($sql, $values, is_string(key($types)) ? $this->extractTypeValues($columns, $types) : $types);
    }
    /**
