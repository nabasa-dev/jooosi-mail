...
{
    public function __construct(private readonly bool $detectRenamedColumns = \true, private readonly bool $detectRenamedIndexes = \true, private readonly bool $reportModifiedIndexes = \true)
    {
    }
    public function withDetectRenamedColumns(bool $detectRenamedColumns): self
    {
        return new self($detectRenamedColumns, $this->detectRenamedIndexes, $this->reportModifiedIndexes);
    }
    ...
    {
        return new self($this->detectRenamedColumns, $detectRenamedIndexes, $this->reportModifiedIndexes);
    }
    ...
    {
        return new self($this->detectRenamedColumns, $this->detectRenamedIndexes, $reportModifiedIndexes);
    }
