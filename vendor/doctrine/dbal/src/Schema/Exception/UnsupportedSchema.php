...
{
    public static function sqliteMissingForeignKeyConstraintReferencedColumns(?string $constraintName, string $referencingTableName, string $referencedTableName): self
    {
