...
final readonly class IndexColumnMetadataRow
{
     ...
     */
    public function __construct(private ?string $schemaName, private string $tableName, private string $indexName, private IndexType $type, private bool $isClustered, private ?string $predicate, private string $columnName, private ?int $columnLength)
    {
    }
