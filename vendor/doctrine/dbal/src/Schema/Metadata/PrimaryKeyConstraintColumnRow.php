...
final readonly class PrimaryKeyConstraintColumnRow
{
     ...
     */
    public function __construct(private ?string $schemaName, private string $tableName, private ?string $constraintName, private bool $isClustered, private string $columnName)
    {
    }
