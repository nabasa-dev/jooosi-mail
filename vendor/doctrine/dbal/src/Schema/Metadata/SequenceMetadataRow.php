...
final readonly class SequenceMetadataRow
{
     ...
     */
    public function __construct(private ?string $schemaName, private string $sequenceName, private int $allocationSize, private int $initialValue, private ?int $cacheSize)
    {
    }
