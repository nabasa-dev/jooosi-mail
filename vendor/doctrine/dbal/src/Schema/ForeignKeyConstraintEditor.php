...
final class ForeignKeyConstraintEditor
{
    ...
    public function setReferencingColumnNames(UnqualifiedName $firstColumnName, UnqualifiedName ...$otherColumnNames): self
    {
     ...
     */
    public function setUnquotedReferencingColumnNames(string $firstColumnName, string ...$otherColumnNames): self
    {
        $this->referencingColumnNames = array_map(static fn(string $name): UnqualifiedName => UnqualifiedName::unquoted($name), [$firstColumnName, ...array_values($otherColumnNames)]);
        return $this;
    }
    /**
     * @param non-empty-string $firstColumnName
     * @param non-empty-string ...$otherColumnNames
     */
    public function setQuotedReferencingColumnNames(string $firstColumnName, string ...$otherColumnNames): self
    {
        $this->referencingColumnNames = array_map(static fn(string $name): UnqualifiedName => UnqualifiedName::quoted($name), [$firstColumnName, ...array_values($otherColumnNames)]);
        return $this;
    }
     ...
     */
    public function setUnquotedReferencedTableName(string $unqualifiedReferencedTableName, ?string $referencedTableNameQualifier = null): self
    {
        $this->referencedTableName = OptionallyQualifiedName::unquoted($unqualifiedReferencedTableName, $referencedTableNameQualifier);
        return $this;
    }
    /**
     * @param non-empty-string  $unqualifiedReferencedTableName
     * @param ?non-empty-string $referencedTableNameQualifier
     */
    public function setQuotedReferencedTableName(string $unqualifiedReferencedTableName, ?string $referencedTableNameQualifier = null): self
    {
        $this->referencedTableName = OptionallyQualifiedName::quoted($unqualifiedReferencedTableName, $referencedTableNameQualifier);
        return $this;
    }
    public function setReferencedColumnNames(UnqualifiedName $firstColumnName, UnqualifiedName ...$otherColumnNames): self
    {
     ...
     * @param non-empty-string ...$otherColumnNames
     */
    public function setUnquotedReferencedColumnNames(string $firstColumnName, string ...$otherColumnNames): self
    {
        $this->referencedColumnNames = array_map(static fn(string $name): UnqualifiedName => UnqualifiedName::unquoted($name), [$firstColumnName, ...array_values($otherColumnNames)]);
        return $this;
    }
    /**
     * @param non-empty-string $firstColumnName
     * @param non-empty-string ...$otherColumnNames
     */
    public function setQuotedReferencedColumnNames(string $firstColumnName, string ...$otherColumnNames): self
    {
        $this->referencedColumnNames = array_map(static fn(string $name): UnqualifiedName => UnqualifiedName::quoted($name), [$firstColumnName, ...array_values($otherColumnNames)]);
        return $this;
    }
