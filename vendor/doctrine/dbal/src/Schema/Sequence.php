...
class Sequence extends AbstractNamedObject
{
     ...
     */
    public function __construct(string $name, int $allocationSize = 1, int $initialValue = 1, protected ?int $cache = null)
    {
        parent::__construct($name);
        if ($cache < 0) {
            Deprecation::triggerIfCalledFromOutside('doctrine/dbal', 'https://github.com/doctrine/dbal/pull/7108', 'Passing a negative value as sequence cache size is deprecated.');
        }
    ...
    {
        Deprecation::triggerIfCalledFromOutside('doctrine/dbal', 'https://github.com/doctrine/dbal/pull/7108', '%s is deprecated, use `getCacheSize()` instead.', __METHOD__);
        return $this->cache;
    }
    /** @return ?non-negative-int */
    ...
    {
        Deprecation::triggerIfCalledFromOutside('doctrine/dbal', 'https://github.com/doctrine/dbal/pull/7115', '%s is deprecated. Use Sequence::edit() and SequenceEditor::setAllocationSize() instead.', __METHOD__);
    ...
    {
        Deprecation::triggerIfCalledFromOutside('doctrine/dbal', 'https://github.com/doctrine/dbal/pull/7115', '%s is deprecated. Use Sequence::edit() and SequenceEditor::setInitialValue() instead.', __METHOD__);
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pull/7115', '%s is deprecated. Use Sequence::edit() and SequenceEditor::setCacheSize() instead.', __METHOD__);
        $this->cache = $cache;
        return $this;
    }
    /**
