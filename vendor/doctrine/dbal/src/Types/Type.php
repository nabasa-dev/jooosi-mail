...
abstract class Type
{
    ...
    {
        return new TypeRegistry(array_map(static fn($class) => new $class(), self::BUILTIN_TYPES_MAP));
    }
    /**
    ...
    {
        return array_map(static fn(Type $type): string => $type::class, self::getTypeRegistry()->getMap());
    }
    /**
