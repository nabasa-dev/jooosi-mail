...
use JooosiMailDeps\Doctrine\DBAL\Driver\PgSQL\Exception\UnexpectedValue;
...
final class Result implements ResultInterface
{
    ...
    public function fetchAllNumeric(): array
    {
        ...
        return array_map(fn(array $row) => $this->mapNumericRow($row, $types), pg_fetch_all($this->result, PGSQL_NUM));
    }
    /** {@inheritDoc} */
    public function fetchAllAssociative(): array
    {
        ...
        return array_map(fn(array $row) => $this->mapAssociativeRow($row, $types), pg_fetch_all($this->result, PGSQL_ASSOC));
    }
    /** {@inheritDoc} */
