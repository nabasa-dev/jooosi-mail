...
use OmniMailDeps\Doctrine\DBAL\Platforms\Keywords\PostgreSQLKeywords;
use OmniMailDeps\Doctrine\DBAL\Platforms\PostgreSQL\PostgreSQLMetadataProvider;
...
use OmniMailDeps\Doctrine\DBAL\Schema\PostgreSQLSchemaManager;
...
class PostgreSQLPlatform extends AbstractPlatform
{
    ...
    private function convertSingleBooleanValue(mixed $value, callable $callback): mixed
    {
        ...
        throw new UnexpectedValueException(sprintf('Unrecognized boolean literal, %s given.', $value));
    }
    /**
    ...
    {
        if (in_array($item, $this->booleanLiterals['false'], \true)) {
            return \false;
        }
