...
use OmniMailDeps\Doctrine\DBAL\Platforms\SQLite\SQLiteMetadataProvider\ForeignKeyConstraintDetails;
...
use OmniMailDeps\Doctrine\DBAL\Schema\Exception\UnsupportedSchema;
