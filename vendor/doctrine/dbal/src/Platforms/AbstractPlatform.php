...
use OmniMailDeps\Doctrine\DBAL\Exception\InvalidColumnDeclaration;
...
use OmniMailDeps\Doctrine\DBAL\Exception\InvalidColumnType\ColumnPrecisionRequired;
use OmniMailDeps\Doctrine\DBAL\Exception\InvalidColumnType\ColumnScaleRequired;
use OmniMailDeps\Doctrine\DBAL\Exception\InvalidColumnType\ColumnValuesRequired;
use OmniMailDeps\Doctrine\DBAL\LockMode;
use OmniMailDeps\Doctrine\DBAL\Platforms\Exception\NoColumnsSpecifiedForTable;
...
use OmniMailDeps\Doctrine\DBAL\Schema\AbstractSchemaManager;
...
use OmniMailDeps\Doctrine\DBAL\Schema\SchemaDiff;
...
use OmniMailDeps\Doctrine\DBAL\Schema\UniqueConstraint;
use OmniMailDeps\Doctrine\DBAL\SQL\Builder\DefaultSelectSQLBuilder;
use OmniMailDeps\Doctrine\DBAL\SQL\Builder\DefaultUnionSQLBuilder;
use OmniMailDeps\Doctrine\DBAL\SQL\Builder\SelectSQLBuilder;
use OmniMailDeps\Doctrine\DBAL\SQL\Builder\UnionSQLBuilder;
