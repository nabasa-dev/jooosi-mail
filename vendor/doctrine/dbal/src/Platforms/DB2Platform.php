...
class DB2Platform extends AbstractPlatform
{
    ...
    {
        $this->doctrineTypeMapping = ['bigint' => Types::BIGINT, 'binary' => Types::BINARY, 'blob' => Types::BLOB, 'character' => Types::STRING, 'clob' => Types::TEXT, 'date' => Types::DATE_MUTABLE, 'decimal' => Types::DECIMAL, 'double' => Types::FLOAT, 'integer' => Types::INTEGER, 'real' => Types::SMALLFLOAT, 'smallint' => Types::SMALLINT, 'time' => Types::TIME_MUTABLE, 'timestamp' => Types::DATETIME_MUTABLE, 'varbinary' => Types::BINARY, 'varchar' => Types::STRING];
    }
    ...
    public function getAlterTableSQL(TableDiff $diff): array
    {
        ...
        foreach ($diff->getChangedColumns() as $columnDiff) {
            ...
            $this->gatherAlterColumnSQL($tableNameSQL, $columnDiff, $sql, $queryParts, $needsReorg);
        }
     ...
     */
    private function gatherAlterColumnSQL(string $table, ColumnDiff $columnDiff, array &$sql, array &$queryParts, bool &$needsReorg): void
    {
    ...
    private function getAlterColumnClausesSQL(ColumnDiff $columnDiff, bool &$needsReorg): array
    {
        ...
        if ($columnDiff->hasTypeChanged() || $columnDiff->hasLengthChanged() || $columnDiff->hasPrecisionChanged() || $columnDiff->hasScaleChanged() || $columnDiff->hasFixedChanged()) {
            $needsReorg = \true;
            $clauses[] = $alterClause . ' SET DATA TYPE ' . $newColumn->getType()->getSQLDeclaration($columnArray, $this);
        }
