...
final readonly class Connection
{
     ...
     */
    public function __construct(public ?int $id, public string $profileKey, public string $name, public ?string $dsn = null, public array $settings = [], public array $secrets = [], public bool $enabled = \true, public bool $default = \false, public int $priority = 10, public int $weight = 1, public bool $webhookEnabled = \false)
    {
    }
    /**
     * @since 0.1.0
