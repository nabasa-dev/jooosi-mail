...
final readonly class DeliveryService
{
    ...
    {
        $filteredMailRequest = $this->eventPublisher->applyFilters('f!omni-mail/mail:delivery.request', $mailRequest, $mailLogId, $connection, $deliveryPlan);
