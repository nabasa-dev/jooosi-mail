...
final readonly class ProfileMetadataResolver
{
     ...
     * @since 0.1.0
     */
    public function getKey(MailProfileInterface $profile): string
    {
     ...
     * @since 0.1.0
     */
    public function getLabel(MailProfileInterface $profile): string
    {
     ...
     * @since 0.1.0
     */
    public function getDescription(MailProfileInterface $profile): string
    {
     ...
     * @since 0.1.0
     */
    public function resolve(MailProfileInterface $profile): array
    {
     ...
     * @since 0.1.0
     */
    private function definition(MailProfileInterface $profile): MailProfile
    {
