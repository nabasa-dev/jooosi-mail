...
final class ScalewayProfile extends AbstractMailProfile
{
    ...
    {
        return ['scheme' => ['label' => 'Transport scheme', 'type' => 'choice', 'required' => \false, 'default' => 'scaleway+api', 'choices' => $this->getSupportedSchemes()], 'project_id' => ['label' => 'Scaleway project ID', 'type' => 'text', 'required' => \true], 'api_key' => ['label' => 'Scaleway API key', 'type' => 'password', 'required' => \true], 'region' => ['label' => 'Scaleway region', 'type' => 'text', 'required' => \false, 'visible_when' => [$this->conditionIn('scheme', 'scaleway+api')]]];
    }
    #[Override]
