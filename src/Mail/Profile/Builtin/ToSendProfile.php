...
#[MailProfile(
    key: 'tosend',
    label: 'toSend',
    description: 'Send mail through toSend using its REST API.',
    website: 'https://tosend.com',
    docsUrl: 'https://tosend.com/docs/api/send-email/',
...
final class ToSendProfile extends AbstractMailProfile
{
    ...
    {
        return [
            'scheme' => ['label' => 'Transport scheme', 'type' => 'choice', 'required' => false, 'default' => 'tosend+api', 'choices' => $this->getSupportedSchemes()],
            'api_key' => ['label' => 'toSend API key', 'type' => 'password', 'required' => true],
        ];
    }
