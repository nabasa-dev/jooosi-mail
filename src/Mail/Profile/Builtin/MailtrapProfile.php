...
#[MailProfile(
    key: 'mailtrap',
    label: 'Mailtrap',
    description: 'Send mail through Mailtrap using the Symfony bridge SMTP, live API, or sandbox API transport.',
    website: 'https://mailtrap.io',
    docsUrl: 'https://help.mailtrap.io/',
    useCases: ['testing', 'transactional'],
)]
