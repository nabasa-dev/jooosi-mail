...
#[MailProfile(
    key: 'mailomat',
    label: 'Mailomat',
    description: 'Send mail through Mailomat using the Symfony bridge API or SMTP transport.',
    website: 'https://mailomat.swiss',
...
final class MailomatProfile extends AbstractMailProfile
{
    ...
    {
        return [
            'scheme' => ['label' => 'Transport scheme', 'type' => 'choice', 'required' => false, 'default' => 'mailomat+api', 'choices' => $this->getSupportedSchemes()],
            'api_key' => ['label' => 'Mailomat API key', 'type' => 'password', 'required' => false, 'visible_when' => [$this->conditionIn('scheme', 'mailomat+api')], 'required_when' => [$this->conditionIn('scheme', 'mailomat+api')]],
            'username' => ['label' => 'Mailomat SMTP username', 'type' => 'text', 'required' => false, 'visible_when' => [$this->conditionIn('scheme', 'mailomat+smtp')], 'required_when' => [$this->conditionIn('scheme', 'mailomat+smtp')]],
            'password' => ['label' => 'Mailomat SMTP password', 'type' => 'password', 'required' => false, 'visible_when' => [$this->conditionIn('scheme', 'mailomat+smtp')], 'required_when' => [$this->conditionIn('scheme', 'mailomat+smtp')]],
        ];
    }
