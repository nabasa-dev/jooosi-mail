...
#[MailProfile(
    key: 'smtp',
    label: 'SMTP',
    description: 'Send mail through a remote SMTP server.',
    docsUrl: 'https://symfony.com/doc/current/mailer.html',
    useCases: ['transactional', 'marketing', 'self-hosted'],
)]
final class SmtpProfile extends AbstractMailProfile
{
    ...
    {
        return [
            'scheme' => ['label' => 'SMTP scheme', 'type' => 'choice', 'required' => false, 'default' => 'smtp', 'choices' => ['smtp', 'smtps']],
            'host' => ['label' => 'SMTP host', 'type' => 'text', 'required' => true],
            'port' => ['label' => 'SMTP port', 'type' => 'number', 'required' => false, 'default' => 587],
            'username' => ['label' => 'SMTP username', 'type' => 'text', 'required' => false],
            'password' => ['label' => 'SMTP password', 'type' => 'password', 'required' => false],
        ];
    }
