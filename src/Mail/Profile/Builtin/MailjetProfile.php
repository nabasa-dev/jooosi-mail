...
final class MailjetProfile extends AbstractMailProfile
{
    ...
    {
        return ['scheme' => ['label' => 'Transport scheme', 'type' => 'choice', 'required' => \false, 'default' => 'mailjet+api', 'choices' => $this->getSupportedSchemes()], 'access_key' => ['label' => 'Mailjet access key', 'type' => 'password', 'required' => \true], 'secret_key' => ['label' => 'Mailjet secret key', 'type' => 'password', 'required' => \true], 'sandbox' => ['label' => 'Mailjet sandbox mode', 'type' => 'choice', 'required' => \false, 'default' => 'false', 'choices' => ['false', 'true'], 'visible_when' => [$this->conditionIn('scheme', 'mailjet+api')]]];
    }
    #[Override]
