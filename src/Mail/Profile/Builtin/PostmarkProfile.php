...
final class PostmarkProfile extends AbstractMailProfile
{
    ...
    {
        return ['scheme' => ['label' => 'Transport scheme', 'type' => 'choice', 'required' => \false, 'default' => 'postmark+api', 'choices' => $this->getSupportedSchemes()], 'api_key' => ['label' => 'Postmark server token', 'type' => 'password', 'required' => \true]];
    }
    #[Override]
