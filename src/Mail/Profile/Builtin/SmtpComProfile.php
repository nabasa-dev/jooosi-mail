...
#[MailProfile(
    key: 'smtpcom',
    label: 'SMTP.com',
    description: 'Send mail through SMTP.com using custom API or SMTP transports.',
...
final class SmtpComProfile extends AbstractMailProfile
{
    ...
    {
        return [
            'scheme' => ['label' => 'Transport scheme', 'type' => 'choice', 'required' => false, 'default' => 'smtpcom+api', 'choices' => $this->getSupportedSchemes()],
            'api_key' => ['label' => 'SMTP.com API key', 'type' => 'password', 'required' => false, 'visible_when' => [$this->conditionIn('scheme', 'smtpcom+api')], 'required_when' => [$this->conditionIn('scheme', 'smtpcom+api')]],
            'username' => ['label' => 'SMTP.com SMTP username', 'type' => 'text', 'required' => false, 'visible_when' => [$this->conditionIn('scheme', ['smtpcom+smtp', 'smtpcom+smtps'])], 'required_when' => [$this->conditionIn('scheme', ['smtpcom+smtp', 'smtpcom+smtps'])]],
            'password' => ['label' => 'SMTP.com SMTP password', 'type' => 'password', 'required' => false, 'visible_when' => [$this->conditionIn('scheme', ['smtpcom+smtp', 'smtpcom+smtps'])], 'required_when' => [$this->conditionIn('scheme', ['smtpcom+smtp', 'smtpcom+smtps'])]],
            'channel' => ['label' => 'SMTP.com API channel', 'type' => 'text', 'required' => false, 'visible_when' => [$this->conditionIn('scheme', 'smtpcom+api')]],
        ];
    }
