...
#[MailProfile(
    key: 'ses',
    label: 'Amazon SES',
    description: 'Send mail through Amazon SES using the Symfony bridge API, HTTP, or SMTP transport.',
...
final class SesProfile extends AbstractMailProfile
{
    ...
    {
        return [
            'scheme' => ['label' => 'Transport scheme', 'type' => 'choice', 'required' => false, 'default' => 'ses+api', 'choices' => $this->getSupportedSchemes()],
            'access_key' => ['label' => 'Amazon SES access key ID', 'type' => 'password', 'required' => false, 'visible_when' => [$this->conditionIn('scheme', ['ses+api', 'ses+https'])], 'required_when' => [$this->conditionIn('scheme', ['ses+api', 'ses+https'])]],
            'secret_key' => ['label' => 'Amazon SES secret access key', 'type' => 'password', 'required' => false, 'visible_when' => [$this->conditionIn('scheme', ['ses+api', 'ses+https'])], 'required_when' => [$this->conditionIn('scheme', ['ses+api', 'ses+https'])]],
