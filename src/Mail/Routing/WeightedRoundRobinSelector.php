...
final readonly class WeightedRoundRobinSelector
{
    ...
    public function __construct(
        private WeightedRoundRobinStateRepository $weightedRoundRobinStateRepository,
    ) {
    }
    ...
    {
        $eligibleConnections = array_values(array_filter(
            $connections,
            fn (Connection $connection): bool => $this->isEligibleForPrimary($connection, $healthScores),
        ));
