...
{
    public function __construct(private MailAttemptRepository $mailAttemptRepository, private \OmniMail\Mail\Routing\ConnectionHealthPenaltyProviderInterface $healthPenaltyProvider)
    {
    }
    /**
