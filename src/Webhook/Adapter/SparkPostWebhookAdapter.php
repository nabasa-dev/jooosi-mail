 ...
 */
#[Service]
class SparkPostWebhookAdapter extends AbstractWebhookAdapter
{
    #[Override]
    ...
    public function parse(WP_REST_Request $request, Connection $connection): array
    {
        ...
        foreach ($payload as $event) {
            ...
            $normalized[] = [
                ...
                'event_type' => $this->normalizeMessageSystemsEvent((string) ($eventData['type'] ?? 'received')),
                'transport_message_id' => $this->extractFirstString($eventData, ['message_id']),
                'payload' => $event,
