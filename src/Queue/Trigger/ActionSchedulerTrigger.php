...
{
    public const string RUN_HOOK = 'omni_mail_queue_process_async';

    public const string RECURRING_HOOK = 'omni_mail_queue_process_fallback';

    public const string ASYNC_RUNNER_ACTION = 'as_async_request_queue_runner';

    public const string GROUP = 'omni-mail';

    public const string SCHEDULE_LOCK_OPTION = 'omni_mail_queue_schedule_lock';
    ...
    public function scheduleRecurring(): void
    {
        ...
        as_schedule_recurring_action(time() + MINUTE_IN_SECONDS, MINUTE_IN_SECONDS, self::RECURRING_HOOK, [], self::GROUP, true);
    }
    ...
    private function wakeActionSchedulerAsyncRunner(): void
    {
        ...
        wp_remote_post(add_query_arg([
            'action' => self::ASYNC_RUNNER_ACTION,
            'nonce' => wp_create_nonce(self::ASYNC_RUNNER_ACTION),
