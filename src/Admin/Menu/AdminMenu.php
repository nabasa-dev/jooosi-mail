...
use function OmniMailDeps\Nabasa\VitePlus\assets;
/**
...
final class AdminMenu
{
    ...
    {
        add_menu_page(__('Omni Mail', 'omni-mail'), __('Omni Mail', 'omni-mail'), 'manage_options', self::PAGE_SLUG, [$this, 'render'], 'data:image/svg+xml;base64,' . base64_encode(file_get_contents($this->paths->rootDir . '/omni-mail.svg')), 100);
    }
    /**
     * @since 0.1.0
     */
    ...
    public function enqueue(string $hookSuffix): void
    {
        ...
        wp_add_inline_script(self::ASSET_HANDLE, 'window.omniMailAdmin = ' . wp_json_encode(['apiRoot' => trailingslashit((string) rest_url('omni-mail/v1/admin')), 'nonce' => wp_create_nonce('wp_rest'), 'pluginVersion' => \OMNI_MAIL_VERSION]) . ';', 'before');
    }
    /**
     * @since 0.1.0
     */
