...
import Tick02Icon from "~icons/hugeicons/tick-02"
  ...
  return (
    <MenuPrimitive.Portal>
      <MenuPrimitive.Positioner
        className="windpress-style isolate z-50 outline-none"
        align={align}
