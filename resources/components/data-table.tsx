...
import DragDropVerticalIcon from "~icons/hugeicons/drag-drop-vertical"
...
function DragHandle({ id }: { id: number }) {
  ...
  return (
    ...
    >
      <DragDropVerticalIcon className="size-3 text-muted-foreground" />
    ...
    cell: ({ row }) => (
      <Badge variant="outline" className="px-1.5 text-muted-foreground">
        {row.original.status === "Done" ? (
          <CheckmarkCircle01Icon className="fill-green-500 dark:fill-green-400" />
        ) : (
          <Loading03Icon />
        )}
        {row.original.status}
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            ...
            >
              ...
              Columns
              <ArrowDown01Icon data-icon="inline-end" />
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-32">
              {table
                .getAllColumns()
